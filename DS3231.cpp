...
char *DS3231::getDOWStr(uint8_t format)
{
	...
	char *daysLong[] = {"Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu", "Minggu"};
...
char *DS3231::getMonthStr(uint8_t format)
{
	...
	char *monthLong[] = {"Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"};
